...
BibleVerse.create!([{question: Question.new(text: "How can we know that the Bible really is the true God?", level: 1, theme: 1, section: 2),
...
BibleVerse.create!([{question: Question.new(text: "Is this a question?", level: 1, theme: 1, section: 3),
                    book: "Lamentations",
                    chapter: 3,
                    verse_number: 22,
                    verse_text: "It is of the LORD\"s mercies that we are not consumed, because his compassions fail not."}])
BibleVerse.create!([{question: Question.new(text: "Is this a question?", level: 1, theme: 1, section: 4),
                    book: "1 John",
                    chapter: 3,
                    verse_number: 4,
                    verse_text: "He that loveth not knoweth not God; for God is love."}])
BibleVerse.create!([{question: Question.new(text: "Is this a question?", level: 1, theme: 1, section: 5),
                    book: "Romans",
                    chapter: 1,
                    verse_number: 18,
...
BibleVerse.create!([{question: Question.new(text: "How powerful is God?", level: 1, theme: 2, section: 1),
                    book: "Jeremiah",
                    chapter: 32,
                    verse_number: 17,
...
BibleVerse.create!([{question: Question.new(text: "What does God know?", level: 1, theme: 2, section: 2),
                    book: "1 John",
                    chapter: 3,
                    verse_number: "20b",
                    verse_text: "God is greater than our heart, and knoweth all things."}])
BibleVerse.create!([{question: Question.new(text: "Where is God?", level: 1, theme: 2, section: 3),
                    book: "Jeremiah",
                    chapter: 23,
                    verse_number: "24b",
                    verse_text: "Do not I fill the heavens and the earth? saith the Lord."}])
BibleVerse.create!([{question: Question.new(text: "Can anyone match God\"s greatness?", level: 1, theme: 2, section: 4),
                    book: "1 Timothy",
                    chapter: 1,
                    verse_number: 17,
                    verse_text: "Now unto the King eternal, immortal, invisible, the only wise God, be honour and glory for ever and ever. Amen."}])
BibleVerse.create!([{question: Question.new(text: "How should you respond to God as you learn about his greatness?", level: 1, theme: 2, section: 5),
                    book: "Exodus",
                    chapter: 15,
                    verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: "What is our good God like?", level: 1, theme: 2, section: 6),
                    book: "Psalm",
                    chapter: 34,
                    verse_number: "8a",
                    verse_text: "O taste and see that the LORD is good."}])
BibleVerse.create!([{question: Question.new(text: "Who gives us all things?", level: 1, theme: 2, section: 7),
                    book: "Psalm",
                    chapter: 84,
                    verse_number: "11b",
                    verse_text: "No good thing will he withhold from them that walk uprightly."}])
BibleVerse.create!([{question: Question.new(text: "How good is God?", level: 1, theme: 2, section: 8),
                    book: "Isaiah",
                    chapter: 6,
                    verse_number: "3b",
