...
BibleVerse.create!([{question: Question.new(text: "What is the Bible?", level: :detectives, theme: 1, section: 1),
...
BibleVerse.create!([{question: Question.new(text: "How can we know that the Bible really is the true God?", level: :detectives, theme: 1, section: 2),
...
BibleVerse.create!([{question: Question.new(text: "Does God give everyone good things that they deserve?", level: :detectives, theme: 1, section: 6),
                    book: "Psalm",
                    chapter: 145,
                    verse_number: "9a",
                    verse_text: "The LORD is gracious, and full of compassion, slow to anger, and of great mercy." + " The LORD is good to all."}])
BibleVerse.create!([{question: Question.new(text: "Does God reveal in his word that He is greater than us?", level: :detectives, theme: 1, section: 7),
                    book: "Isaiah",
                    chapter: 55,
                    verse_number: "9a",
                    verse_text: "For as the heavens are higher than the earth, so are my ways higher than your ways."}])
BibleVerse.create!([{question: Question.new(text: "Did God ever have a beginning, or will He ever have an end?", level: :detectives, theme: 1, section: 8),
                    book: "Revelation",
                    chapter: 1,
                    verse_number: "8a",
                    verse_text: "I am Alpha and Omega, the beginning and the end, saith the Lord."}])
BibleVerse.create!([{question: Question.new(text: "Does the Lord ever give up, get tired, or change in any way?", level: :detectives, theme: 1, section: 9),
                    book: "Malachi",
                    chapter: 3,
                    verse_number: "6a",
...
BibleVerse.create!([{question: Question.new(text: "How should you respond to God as you learn about his greatness?", level: :detectives, theme: 2, section: 5),
                    book: "Exodus",
                    chapter: 15,
                    verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: "What is our good God like?", level: :detectives, theme: 2, section: 6),
                    book: "Psalm",
                    chapter: 34,
                    verse_number: "8a",
                    verse_text: "O taste and see that the LORD is good."}])
BibleVerse.create!([{question: Question.new(text: "Who gives us all things?", level: :detectives, theme: 2, section: 7),
                    book: "Psalm",
                    chapter: 84,
                    verse_number: "11b",
                    verse_text: "No good thing will he withhold from them that walk uprightly."}])
BibleVerse.create!([{question: Question.new(text: "How good is God?", level: :detectives, theme: 2, section: 8),
                    book: "Isaiah",
                    chapter: 6,
                    verse_number: "3b",
                    verse_text: "Holy, holy, holy, is the LORD of hosts: the whole earth is full of his glory."}])
BibleVerse.create!([{question: Question.new(text: "Does God ever sin?", level: :detectives, theme: 2, section: 9),
                    book: "Psalm",
                    chapter: 145,
                    verse_number: 17,
                    verse_text: "The LORD is righteous in all his ways, and holy in all his works."}])
BibleVerse.create!([{question: Question.new(text: "Does God ever lie?", level: :detectives, theme: 2, section: 10),
                    book: "Titus",
                    chapter: 1,
                    verse_number: 2,
...
BibleVerse.create!([{question: Question.new(text: "Does God give everyone good things that they do not deserve?"),
                    ...
                    verse_number: 8,
                    verse_text: "The LORD is gracious, and full of compassion; slow to anger, and of great mercy." + " The LORD is good to all."}])
BibleVerse.create!([{question: Question.new(text: "Would God rather punish people or forgive them?", level: :detectives, theme: 3, section: 1),
                    book: "Lamentations",
                    chapter: 3,
                    verse_number: 22,
                    verse_text: "It is of the LORD\"s mercies that we are not consumed, because his compassions fail not."}])
BibleVerse.create!([{question: Question.new(text: "Who is the source of all true love?", level: :detectives, theme: 3, section: 2),
                    book: "1 John",
                    chapter: 4,
                    verse_number: 8,
                    verse_text: "He that loveth not knoweth not God; for God is love."}])
BibleVerse.create!([{question: Question.new(text: "Does God look the other way when we sin?", level: :detectives, theme: 3, section: 3),
                    book: "Romans",
                    chapter: 1,
                    verse_number: 18,
                    verse_text: "For the wrath of God is revealed from heaven against all ungodliness and unrighteousness of men, who hold the truth in unrighteousness."}])
...
BibleVerse.create!([{question: Question.new(text: "Has God always been a Trinity?", level: :detectives, theme: 3, section: 5),
                    book: "John",
                    chapter: 17,
                    verse_number: 24,
...
BibleVerse.create!([{question: Question.new(text: "Why must we believe that God is one God in three Persons, each of Whom is fully God?", level: :detectives, theme: 3, section: 5),
                    book: "Psalm",
                    chapter: 33,
                    verse_number: 4,
                    verse_text: "For the word of the LORD is right; and all his works are done in truth."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that there is only one true God?", level: :detectives, theme: 3, section: 6),
                    book: "Deuteronomy",
                    chapter: 6,
                    verse_number: 4,
                    verse_text: "Hear O Israel:\n The LORD our God is one LORD."}])
BibleVerse.create!([{question: Question.new(text: "Who are the three Persons of the Trinity?", level: :detectives, theme: 3, section: 7),
                    book: "Matthew",
                    chapter: 28,
                    verse_number: 19,
...
BibleVerse.create!([{question: Question.new(text: "What Bible verse lists the Persons of the Trinity and assigns divine qualities to each one?", level: :detectives, theme: 3, section: 8),
                    book: "2 Corinthians",
                    chapter: 13,
                    verse_number: 14,
                    verse_text: "The grace of the Lord Jesus Christ, and the love of God, and the communion of the Holy Ghost, be with you all."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Father is God?", level: :detectives, theme: 3, section: 9),
                    book: "Philipians",
                    chapter: 1,
                    verse_number: 2,
                    verse_text: "Grace be unto you, and peace, from God our Father, and from the Lord Jesus Christ."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Son, Jesus Christ, is God?", level: :detectives, theme: 3, section: 10),
                    book: "Hebrews",
                    chapter: 1,
                    verse_number: 8,
...
BibleVerse.create!([{question: Question.new(text: "How should you respond to learning that God is a Trinity?", level: :detectives, theme: 5, section: 1),
                    book: "2 Samuel",
                    chapter: 7,
                    verse_number: 22,
...
BibleVerse.create!([{question: Question.new(text: "What is \"creationism\"?", level: :detectives, theme: 4, section: 2),
                    book:         "Genesis",
                    chapter:      1,
                    verse_number: 1,
...
BibleVerse.create!([{question: Question.new(text: "How did God create the world?", level: :detectives, theme: 5, section: 6),
                    book: "Psalm",
                    chapter: 33,
                    verse_number: 6,
                    verse_text: "By the word of the LORD were the heavens made; and all the host of them by the breath of his mouth."}])
BibleVerse.create!([{question: Question.new(text: "How can we know for sure that god made everything?", level: :detectives, theme: 5, section: 7),
                    book: "Hebrews",
                    chapter: 11,
                    verse_number: "3a",
                    verse_text: "Through faith we understand that the worlds were framed by the word of God."}])
BibleVerse.create!([{question: Question.new(text: "What does God\"s creative handiwork show us?", level: :detectives, theme: 5, section: 8),
                    book: "Romans",
                    chapter: 1,
                    verse_number: "20a",
...
# God"s View of You
BibleVerse.create!([{question: Question.new(text: "How did the first human come to be?", level: :detectives, theme: 6, section: 1),
                    book: "Genesis",
                    chapter: 2,
                    verse_number: "7a",
...
BibleVerse.create!([{question: Question.new(text: "What is the Bible?", level: :defenders, theme: 1, section: 1),
...
BibleVerse.create!([{question: Question.new(text: "How can we know that the Bible really is the true Word of God?", level: :defenders, theme: 1, section: 2),
                    book: "1 Corinthians",
                    chapter: 2,
                    verse_number: 12,
...
BibleVerse.create!([{question: Question.new(text: "What does the Bible teach us?", level: :defenders, theme: 1, section: 5),
                    book: "Ecclesiastes",
                    chapter: 12,
                    verse_number: 13,
...
BibleVerse.create!([{question: Question.new(text: "Can we be sure that God\"s Word is still good and true for us today?", level: :defenders, theme: 1, section: 6),
                    book: "Matthew",
                    chapter: 5,
                    verse_number: 18,
...
BibleVerse.create!([{question: Question.new(text: "Why do we need the Bible?", level: :defenders, theme: 1, section: 7),
                    book: "2 Timothy",
                    chapter: 3,
                    verse_number: 15,
...
BibleVerse.create!([{question: Question.new(text: "How can we truly get to know God?", level: :defenders, theme: 1, section: 8),
                    book: "Romans",
                    chapter: 10,
                    verse_number: 17,
                    verse_text: "So then faith cometh by hearing, and hearing by the word of God."
                    }])
BibleVerse.create!([{question: Question.new(text: "What authority does the Bible have over us?", level: :defenders, theme: 1, section: 9),
                    book: "2 Timothy",
                    chapter: 3,
                    verse_number: 16,
...
BibleVerse.create!([{question: Question.new(text: "Did God ever have a beginning, or will He ever have an end?", level: :defenders, theme: 2, section: 2),
                     book: "Revelation",
                     chapter: 1,
                     verse_number: 8,
...
BibleVerse.create!([{question: Question.new(text: "Does the Lord ever give up, get tired, or change in any way?", level: :defenders, theme: 2, section: 3),
                    book: "Malachi",
                    chapter: 3,
                    verse_number: "6a",
                    verse_text: "For I am the LORD, I change not."
                    }])
BibleVerse.create!([{question: Question.new(text: "Does God have a body like humans do?", level: :defenders, theme: 2, section: 4),
                    book: "John",
                    chapter: 4,
                    verse_number: 24,
                    verse_text: "God is a spirit: and they that worship him must worship him in spirit and in truth."
                    }])
BibleVerse.create!([{question: Question.new(text: "How powerful is God?", level: :defenders, theme: 2, section: 5),
                     book: "Jeremiah",
                     chapter: 32,
                     verse_number: 17,
                     verse_text: "Ah Lord GOD! behold, thou hast made the heavens and the earth by thy great power and stretched out arm, and there is nothing too hard for thee."
                     }])
BibleVerse.create([{question: Question.new(text: "What does God know?", level: :defenders, theme: 2, section: 6),
                    book: "1 John",
                    chapter: 3,
                    verse_number: "20b",
                    verse_text: "God is greater than our heart, and knoweth all things."
                    }])
BibleVerse.create([{question: Question.new(text: "Can anyone match God\"s greatness?", level: :defenders, theme: 2, section: 7),
                    book: "1 Timothy",
                    chapter: 1,
                    verse_number: 17,
                    verse_text: "Now unto the King eternal, immortal, invisible, the only wise God, be honour and glory for ever and ever. Amen."
                    }])
BibleVerse.create!([{question: Question.new(text: "How should you respond to God as you learn about his greatness?", level: :defenders, theme: 2, section: 8),
                     book: "Exodus",
                     chapter: 15,
                     verse_number: 11,
                     verse_text: "Who is like unto thee, O LORD, among the gods? who is like thee, glorious in holiness, fearful in praises, doing wonders?"
                     }])
BibleVerse.create!([{question: Question.new(text: "What is our good God like?", level: :defenders, theme: 2, section: 9),
                     book: "Psalm",
                     chapter: 34,
                     verse_number: 8,
                     verse_text: "O taste and see that the LORD is good: blessed is the man that trusteth in him."
                     }])
BibleVerse.create!([{question: Question.new(text: "Who gives us all good things?", level: :defenders, theme: 2, section: 10),
                     book: "Psalm",
                     chapter: 84,
                     verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: "How good is God?", level: :defenders, theme: 3, section: 1),
                    book: "Isaiah",
                    chapter: 6,
                    verse_number: "3b",
                    verse_text: "Holy holy holy, is the Lord of hosts: the whole earth is full of glory."
                    }])
BibleVerse.create!([{question: Question.new(text: "Does God ever sin?", level: :defenders, theme: 3, section: 2),
                    book: "Psalm",
                    chapter: 145,
                    verse_number: 17,
                    verse_text: "The LORD is righteous in all his ways, and holy in all his works."
                    }])
BibleVerse.create!([{question: Question.new(text: "Does God ever lie?", level: :defenders, theme: 3, section: 3),
                    book: "Titus",
                    chapter: 1,
                    verse_number: 2,
                    verse_text: "In hope of eternl life, which God, that cannot lie, promised before the world began."
                    }])
BibleVerse.create!([{question: Question.new(text: "Does God give everyone good things do not deserve?", level: :defenders, theme: 3, section: 4),
                     book: "Psalm",
                     chapter: 145,
                     verse_number: 8,
...
BibleVerse.create!([{question: Question.new(text: "Would God rather punish people or forgive them?", level: :defenders, theme: 3, section: 5),
                     book: "Lamentations",
                     chapter: 3,
                     verse_number: 22,
                     verse_text: "It is of the LORD\"s mercies that we are not consumed, because his compassions fail not."
                     }])
BibleVerse.create!([{question: Question.new(text: "Who is the source of all true love?", level: :defenders, theme: 3, section: 6),
                     book: "1 John",
                     chapter: 4,
                     verse_number: 8,
                     verse_text: "He that loveth not knoweth not God; for God is love."
                     }])
BibleVerse.create!([{question: Question.new(text: "How can you please God?", level: :defenders, theme: 3, section: 7),
                     book: "2 Corinthians",
                     chapter: 5,
                     verse_number: 14,
...
BibleVerse.create!([{question: Question.new(text: "Where does the word Trinity mean in relation to God?", level: :defenders, theme: 3, section: 8),
                     book: "Jeremiah",
                     chapter: 10,
                     verse_number: 6,
...
BibleVerse.create!([{question: Question.new(text: "Why must we believe that God is one God in three Presons, each of Whom is fully God?", level: :defenders, theme: 3, section: 9),
                     book: "Psalm",
                     chapter: 33,
                     verse_number: 4,
                     verse_text: "For the word of the LORD is right; and all his works are done in truth."
                     }])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that there is only one true God?", level: :defenders, theme: 3, section: 10),
                     book: "Deuteronomy",
                     chapter: 6,
                     verse_number: 4,
                     verse_text: "Hear, O Israel: The LORD our God is one LORD."
                     }])
BibleVerse.create!([{question: Question.new(text: "Who are the three Persons of the Trinity?", level: :defenders, theme: 4, section: 1),
                     book: "Matthew",
                     chapter: 6,
                     verse_number: 19,
                     verse_text: "Go ye therefore, and teach all nations, baptizing them in the name of the Father,and of the Son, and of the Holy Ghost."
                     }])
BibleVerse.create!([{question: Question.new(text: "What Bible verse lists the Persons of the Trinity and assigns divine qualities to each one?", level: :defenders, theme: 4, section: 2),
                     book: "2 Corinthians",
                     chapter: 13,
                     verse_number: 14,
                     verse_text: "The Grace of the Lord Jesus Christ, and the Love of God, and the communion of the Holy Ghost, be with you all."
                     }])
BibleVerse.create!([{question: Question.new(text: "What is creationism?", level: :defenders, theme: 4, section: 3),
                     book: "Genesis",
                     chapter: 1,
                     verse_number: 1,
                     verse_text: "In the beginning, God created the heaven and the earth."
                     }])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Father is God?", level: :defenders, theme: 4, section: 4),
                     book: "Philipians",
                     chapter: 1,
                     verse_number: 2,
                     verse_text: "Grace be unto you, and peace, from God our Father, and from the Lord Jesus Christ."
                     }])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Son,Jesus Christ, is God?", level: :defenders, theme: 4, section: 5),
                     book: "Hebrews",
                     chapter: 1,
                     verse_number: 8,
...
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Holy Spirit is God?", level: :defenders, theme: 4, section: 6),
                     book: "2 Corinthians",
                     chapter: 3,
                     verse_number: 17,
                    verse_text: "Now the Lord is the Spirit: and where the Spirit of the Lord is, there is liberty."
                    }])
BibleVerse.create!([{question: Question.new(text: "How should you respond to learning that God is a Trinity?", level: :defenders, theme: 4, section: 7),
                     book: "2 Samuel",
                     chapter: 7,
                     verse_number: 22,
...
BibleVerse.create!([{question: Question.new(text: "What does Gods creative handiwork show us?", level: :defenders, theme: 4, section: 8),
                     book: "Romans",
                     chapter: 1,
                     verse_number: "20a",
...
BibleVerse.create!([{question: Question.new(text: "Who created you, the world, and everything in the world?", level: :defenders, theme: 4, section: 9),
                     book: "Isaiah",
                     chapter: 45,
                     verse_number: 18,
...
BibleVerse.create!([{question: Question.new(text: "Was there anything evil or bad about Gods original Creation?", level: :defenders, theme: 4, section: 10),
                     book: "Genesis",
                     chapter: 1,
                     verse_number: 31,
...
BibleVerse.create!([{question: Question.new(text: "Why did God create the world and everything in it?", level: :defenders, theme: 5, section: 1),
                     book: "Revelation",
                     chapter: 4,
                     verse_number: 4,
                     verse_text: "Thou art worthy, O Lord, to receive glory and honour and power: for thou hast created all things, and for thy pleasure they are and were created."
                     }])
BibleVerse.create!([{question: Question.new(text: 'How long did God take to create the world?', level: :defenders, theme: 5, section: 2),
                     book: 'Exodus',
                     chapter: 20,
                     verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: 'How can we know for sure that God made everything?', level: :defenders, theme: 5, section: 3),
                     book: 'Hebrews',
                     chapter: 11,
                     verse_number: 3,
...
BibleVerse.create!([{question: Question.new(text: 'What does Gods creative handiwork show us?', level: :defenders, theme: 5, section: 4),
                     book: 'Romans',
                     chapter: 1,
                     verse_number: 20,
...
BibleVerse.create!([{question: Question.new(text: 'Is every descendant of Adam a sinner?', level: :defenders, theme: 5, section: 5),
                     book: 'Romans',
                     chapter: 5,
                     verse_number: '12a',
                     verse_text: 'By one man sin enetered into the world, and death by sin.'
                     }])
BibleVerse.create!([{question: Question.new(text: 'Did God create all the invisible things?', level: :defenders, theme: 5, section: 6),
                     book: 'Colossians',
                     chapter: 1,
                     verse_number: 16,
...
BibleVerse.create!([{question: Question.new(text: 'How should you respond to God, your Creator?', level: :defenders, theme: 5, section: 7),
                     book: 'Romans',
                     chapter: 14,
                     verse_number: 12,
                     verse_text: 'So then every one of us shall give account himself to God.'
                     }])
BibleVerse.create!([{question: Question.new(text: 'How did the first human come to be?', level: :defenders, theme: 5, section: 8),
                     book: 'Genesis',
                     chapter: 2,
                     verse_number: 7,
...
BibleVerse.create!([{question: Question.new(text: 'Where does the phrase made in the image of God mean?', level: :defenders, theme: 5, section: 9),
                     book: 'Genesis',
                     chapter: 1,
                     verse_number: 27,
                     verse_text: 'So God created man in his own image, in the image of God created he him, male and female creaed he them.'
                     }])
BibleVerse.create!([{question: Question.new(text: 'Why people the most glorious part of Gods Creation?', level: :defenders, theme: 5, section: 10),
                     book: 'Psalm',
                     chapter: 86,
                     verse_number: 9,
...
BibleVerse.create!([{question: Question.new(text: 'Why did God create you?', level: :defenders, theme: 6, section: 1),
                     book: 'Psalm',
                     chapter: 86,
                     verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: 'What were Adam and Eve like when God first created them?', level: :defenders, theme: 6, section: 2),
                     book: 'Psalm',
                     chapter: 16,
                     verse_number: 11,
...
BibleVerse.create!([{question: Question.new(text: 'Is every descendant of Adam a sinner?', level: :defenders, theme: 6, section: 3),
                     book: 'Romans',
                     chapter: 5,
                     verse_number: 12,
...
BibleVerse.create!([{question: Question.new(text: 'What is sin?', level: :defenders, theme: 6, section: 4),
                     book: 'Romans',
                     chapter: 3,
                     verse_number: 23,
                     verse_text: 'For all have sinned, and come short of the glory of God.'
                     }])
BibleVerse.create!([{question: Question.new(text: 'What are the effects of Adams sin on humanity?', level: :defenders, theme: 6, section: 5),
                     book: '1 Corinthians',
                     chapter: 15,
                     verse_number: 22,
                     verse_text: 'For as in Adam all die, even so in Christ shall all be made alive.'
                     }])
BibleVerse.create!([{question: Question.new(text: 'How has Adams sin effected you?', level: :defenders, theme: 6, section: 6),
                     book: 'Romans',
                     chapter: 7,
                     verse_number: 18,
