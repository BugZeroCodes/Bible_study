...
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach any errors or lies?", level: :detectives, theme: 1, section: 4),
                    book: "Psalm",
                    chapter: 119,
                    verse_number: 160,
                    verse_text: "Thy word is true from the beginning: and ebery one of thy righteous judgments endureth for ever."}])
BibleVerse.create!([{question: Question.new(text: "What does the Bible teach us?", level: :detectives, theme: 1, section: 5),
                    book: "Ecclestiastes",
                    chapter: 12,
                    verse_number: 13,
...
BibleVerse.create!([{question: Question.new(text: "How can we truly get to know God?", level: :detectives, theme: 1, section: 8),
                    book: "Romans",
                    chapter: 10,
                    verse_number: 17,
                    verse_text: "So then faith cometh by hearing and hearing by the word of God."}])
BibleVerse.create!([{question: Question.new(text: "What authority does the Bible have over us?", level: :detectives, theme: 1, section: 9),
                    book: "2 Timothy",
                    chapter: 3,
                    verse_number: 16,
...
BibleVerse.create!([{question: Question.new(text: 'Does the Lord ever give up, get tired, or change in any way?', level: :detectives, theme: 2, section: 4),
                     book: 'Malachi',
                     chapter: 3,
                     verse_number: 6,
                     verse_text: 'For I am the LORD, I change not.'}])
BibleVerse.create!([{question: Question.new(text: 'Does God have a body like human beings do?', level: :detectives, theme: 2, section: 5),
                     book: "John",
                     chapter: 4,
                     verse_number: 24,
                     verse_text: "God is a Spirit and they that worship him must worship him in spirit and in truth.",}])
BibleVerse.create!([{question: Question.new(text: 'How powerful is God?', level: :detectives, theme: 2, section: 6),
                     book: 'Jeremiah',
                     chapter: 32,
                     verse_number: 17,
...
BibleVerse.create!([{question: Question.new(text: 'What does God know?', level: :detectives, theme: 2, section: 7),
                     book: "1 John",
                     chapter: 3,
                     verse_number: 20,
                     verse_text: "God is greater than our heart, and knoweth all things.",}])
BibleVerse.create!([{question: Question.new(text: 'Where is God?', level: :detectives, theme: 2, section: 8),
                    book: 'Jeremiah',
                    chapter: 23,
                    verse_number: 24,
                    verse_text: "Do not I fill heaven and earth? saith the Lord.",}])
BibleVerse.create!([{question: Question.new(text: "Can anyone match God\"s greatness?", level: :detectives, theme: 2, section: 9),
                    book: "1 Timothy",
                    chapter: 1,
                    verse_number: 17,
                    verse_text: "Now unto the King eternal, immortal, invisible, the only wise God, be honour and glory for ever and ever. Amen."}])
BibleVerse.create!([{question: Question.new(text: "How should you respond to God as you learn about his greatness?", level: :detectives, theme: 2, section: 10),
                    book: "Exodus",
                    chapter: 15,
                    verse_number: 11,
  ...
  # The Goodness of God
BibleVerse.create!([{question: Question.new(text: "What is our good God like?", level: :detectives, theme: 3, section: 1),
                    book: "Psalm",
                    chapter: 34,
                    verse_number: "8a",
                    verse_text: "O taste and see that the LORD is good."}])
BibleVerse.create!([{question: Question.new(text: "Who gives us all things?", level: :detectives, theme: 3, section: 2),
                    book: "Psalm",
                    chapter: 84,
                    verse_number: "11b",
                    verse_text: "No good thing will he withhold from them that walk uprightly."}])
BibleVerse.create!([{question: Question.new(text: "How good is God?", level: :detectives, theme: 3, section: 3),
                    book: "Isaiah",
                    chapter: 6,
                    verse_number: "3b",
                    verse_text: "Holy, holy, holy, is the LORD of hosts: the whole earth is full of his glory."}])
BibleVerse.create!([{question: Question.new(text: "Does God ever sin?", level: :detectives, theme: 3, section: 4),
                    book: "Psalm",
                    chapter: 145,
                    verse_number: 17,
                    verse_text: "The LORD is righteous in all his ways, and holy in all his works."}])
BibleVerse.create!([{question: Question.new(text: "Does God ever lie?", level: :detectives, theme: 3, section: 5),
                    book: "Titus",
                    chapter: 1,
                    verse_number: 2,
                    verse_text: "In hope of eternal life, which God, that cannot lie, promised before the world began."}])
q = Question.new(text: "Does God give everyone good things that they do not deserve?", level: :detectives, theme: 3, section: 6)
...
BibleVerse.create!([{question: q,
                    ...
                    chapter: 145,
                    verse_number: '9a',
                    verse_text: "The LORD is good to all."}])
...
BibleVerse.create!([{question: Question.new(text: "Does God look the other way when we sin?", level: :detectives, theme: 3, section: 9),
                    book: "Romans",
                    chapter: 1,
                    verse_number: 18,
...
# The Trinity
q = Question.new(text: "What does the word \"Trinity\" mean in relation to God?", level: :detectives, theme: 4, section: 1)
BibleVerse.create!([{question: q,
                    book: "Jeremiah",
                    chapter: 10,
                    verse_number: '6',
...
BibleVerse.create!([{question: Question.new(text: "Why must we believe that God is one God in three Persons, each of Whom is fully God?", level: :detectives, theme: 4, section: 3),
                    book: "Psalm",
                    chapter: 33,
                    verse_number: 4,
                    verse_text: "For the word of the LORD is right; and all his works are done in truth."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that there is only one true God?", level: :detectives, theme: 4, section: 4),
                    book: "Deuteronomy",
                    chapter: 6,
                    verse_number: 4,
                    verse_text: "Hear O Israel:\n The LORD our God is one LORD."}])
BibleVerse.create!([{question: Question.new(text: "Who are the three Persons of the Trinity?", level: :detectives, theme: 4, section: 5),
                    book: "Matthew",
                    chapter: 28,
                    verse_number: 19,
...
BibleVerse.create!([{question: Question.new(text: "What Bible verse lists the Persons of the Trinity and assigns divine qualities to each one?", level: :detectives, theme: 4, section: 6),
                    book: "2 Corinthians",
                    chapter: 13,
                    verse_number: 14,
                    verse_text: "The grace of the Lord Jesus Christ, and the love of God, and the communion of the Holy Ghost, be with you all."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Father is God?", level: :detectives, theme: 4, section: 7),
                    book: "Philipians",
                    chapter: 1,
                    verse_number: 2,
                    verse_text: "Grace be unto you, and peace, from God our Father, and from the Lord Jesus Christ."}])
BibleVerse.create!([{question: Question.new(text: "Does the Bible teach that the Son, Jesus Christ, is God?", level: :detectives, theme: 4, section: 8),
                    book: "Hebrews",
                    chapter: 1,
                    verse_number: 8,
...
BibleVerse.create!([{question: Question.new(text: "How should you respond to learning that God is a Trinity?", level: :detectives, theme: 4, section: 10),
                    book: '2 Samuel',
                    chapter: 7,
                    verse_number: 22,
...
BibleVerse.create!([{question: Question.new(text: "Was there anything evil or bad about God\"s original Creation?", level: :detectives, theme: 5, section: 2),
                    book: "Isaiah",
                    chapter: 45,
                    verse_number: "18a",
                    verse_text: "For thus saith the LORD that created the heavens; God himself that formes the earth and made it; he hath established it, he created it not in vain.",}])
BibleVerse.create!([{question: Question.new(text: "Why did God create the world and everything in it?", level: :detectives, theme: 5, section: 3),
                    book: "Genesis",
                    chapter: 1,
                    verse_number: 31,
                    verse_text: "And God saw everything that he had made, and, behold, it was very good."}])
BibleVerse.create!([{question: Question.new(text: "Why did God create the world and everything in it?", level: :detectives, theme: 5, section: 4),
                    ...
                    chapter: 4,
                    verse_number: 11,
                    verse_text: "Thou are worthy, O Lord, to receive glory and honour and power: for thou hast created all things, and for thy pleasure they are and were created."}])
...
q = Question.new(text: "Why are people the most glorious part of God's Creation?", level: :detectives, theme: 6, section: 3)
BibleVerse.create!([{question: q,
                    book: "Psalm",
                    chapter: 86,
                    verse_number: '9',
...
q = Question.new(text: "Why did God create you?", level: :detectives, theme: 6, section: 4)
BibleVerse.create!([{question: q,
                    book: "Psalm",
                    chapter: 86,
                    verse_number: '11',
...
# The Greatness of God
q = Question.new(text: "Does God reveal in His Word that He is greater than us?", level: :defenders, theme: 2, section: 1)
BibleVerse.create!([{question: q,
                    book: "Isaiah",
                    chapter: 55,
                    verse_number: '8',
                    verse_text: "For my thoughts are not your thoughts, neither are your ways my ways, saith the Lord."}])
BibleVerse.create!([{question: q,
                    book: "Isaiah",
                    chapter: 55,
                    verse_number: '9',
...
BibleVerse.create!([{question: Question.new(text: 'Does God ever lie?', level: :defenders, theme: 3, section: 5),
                     ...
                     verse_number: 2,
                     verse_text: 'In hope of eternal life, which God, that cannot lie, promised before the world began.'}])
q = Question.new(text: 'Does God give to everyone good things they do not deserve?', level: :defenders, theme: 3, section: 6)
BibleVerse.create!([{question: q,
                     book: 'Psalm',
                     chapter: 145,
                     verse_number: '8',
...
BibleVerse.create!([{question: q,
                    ...
                    chapter: 145,
                    verse_number: '9',
                    verse_text: "The Lord is good to all: ans his tender mercies are over all his works."}])
...
BibleVerse.create!([{question: Question.new(text: "Does God look the other way when we sin?", level: :defenders, theme: 3, section: 9),
                     ...
                     verse_number: 18,
                     verse_text: "For the wrath of God is revealed from heaven against all ungodliness and unrighteousness of men, who hold the truth in unrighteousness."}])
q = Question.new(text: 'How can you please God?', level: :defenders, theme: 3, section: 10)
BibleVerse.create!([{question: q,
                     book: '2 Corinthians',
                     chapter: 5,
                     verse_number: "14",
...
q = Question.new(text: "Why are people the most glorious part of God\"s Creation?", level: :defenders, theme: 6, section: 3)
BibleVerse.create!([{question: q,
                     book: "Psalm",
                     chapter: 86,
                     verse_number: "9",
...
BibleVerse.create!([{question: q,
                    ...
                    verse_number: "10",
                    verse_text: "For thou art great, and doest wonderous things: thou art God alone."}])
q = Question.new(text: 'Why did God create you?', level: :defenders, theme: 6, section: 4)
BibleVerse.create!([{question: q,
                     book: 'Psalm',
                     chapter: 86,
                     verse_number: "11",
