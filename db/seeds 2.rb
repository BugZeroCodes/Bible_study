...
BibleVerse.create!([{question: Question.new(text: "Where is God?"),
                    book: "Jeremiah",
                    chapter: 23,
                    verse_number: "24b",
...
BibleVerse.create!([{question: Question.new(text: "Who gives us all things?"),
                    book: "Psalm",
                    chapter: 84,
                    verse_number: "11b",
...
BibleVerse.create!([{question: Question.new(text: "Who is the source of all true love?"),
                    ...
                    verse_number: 8,
                    verse_text: "He that loveth not knoweth not God; for God is love."}])
BibleVerse.create!([{question: Question.new(text: "Does God look the other way when we sin?"),
                    book: "Romans",
                    chapter: 1,
                    verse_number: 18,
                    verse_text: "For the wrath of God is revealed from heaven against all ungodliness and unrighteousness of men, who hold the truth in unrighteousness."}])
...
BibleVerse.create!([{question: Question.new(text: "Has God always been a Trinity?"),
                    book: "John",
                    chapter: 17,
                    verse_number: 24,
...
BibleVerse.create!([{question: Question.new(text: "Why must we believe that God is one God in three Persons, each of Whom is fully God?"),
                    book: "Psalm",
                    chapter: 33,
                    verse_number: 4,
...
BibleVerse.create!([{question: Question.new(text: "What does God\"s creative handiwork show us?"),
                    book: "Romans",
                    chapter: 1,
                    verse_number: "20a",
...
BibleVerse.create!([{question: Question.new(text: "Why are people the most glorious part of God\"s Creation?"),
                    book: "Psalm",
                    chapter: 86,
                    verse_number: 9,
...
BibleVerse.create!([{question: Question.new(text: "What are the effects of Adam\"s sin on humanity?"),
                    book: "1 Corinthians",
                    chapter: 15,
                    verse_number: 22,
                    verse_text: "For as in Adam all die, even so in Christ shall all be made alive."}])
BibleVerse.create!([{question: Question.new(text: "What did God do to save sinners from their sin?"),
                    book: "John",
                    chapter: 3,
                    verse_number: 16,
...
BibleVerse.create!([{question: Question.new(text: "How has Adam\"s sin effected you?"),
                    book: "Romans",
                    chapter: 7,
                    verse_number: "18a",
...
BibleVerse.create!([{question: Question.new(text: 'Why people the most glorious part of Gods Creation?'),
                     ...
                     chapter: 86,
                     verse_number: 9,
                     verse_text: 'All nations whom thou hast made '
